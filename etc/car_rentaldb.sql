...
CONSTRAINT `pick_up_datetime_fkey` FOREIGN KEY (`pick_up_datetime`) REFERENCES `Reservation` (`pick_up_datetime`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CONSTRAINT `return_datetime_fkey` FOREIGN KEY (`return_datetime`) REFERENCES `Reservation` (`ReturnDateTime`) ON DELETE CASCADE ON UPDATE CASCADE,
) ENGINE=InnoDB DEFAULT CHARSET=latin1;*/
-- --------------------------------------------------------
